...
public final class ServidorSocket {
	...
	public ServidorSocket(String address) {
		this();

		this.setAddress(address);
	}

	public ServidorSocket(String address,int port) {
		this(address);

		this.setPort(port);
	}

	public ServidorSocket(String address,int port,int timeout) {
		this(address,port);
